...
with digraph.subgraph(name='cluster_0') as cluster:
    cluster.attr(shape='box', style='bold', color='cadetblue4')
...
# clustered:
with digraph.subgraph(name='cluster_1') as cluster:
    cluster.attr(shape='box', style='bold', color='cadetblue4')
    cluster.node(n_dict['type 4 node'][7])
    cluster.node(n_dict['type 4 node'][8])
